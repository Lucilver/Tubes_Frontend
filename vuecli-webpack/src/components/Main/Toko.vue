        ...
        <v-card>
            <v-list-item>
                <v-list-item-avatar color="grey"> 
                    <img src="https://st2.depositphotos.com/50337402/47103/v/600/depositphotos_471035386-stock-illustration-badge-gold-plated-metalic-icon.jpg">
                </v-list-item-avatar>
                <v-list-item-content>
    ...
    data() {
        return{
            ...
            headers: [
                ...
                { text: "Alamat Toko", value: "hargaBarang" },
            ],
            editedIndex: -1,
            todos: [
                {
